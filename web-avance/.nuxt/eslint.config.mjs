...
export const options = resolveOptions({
  ...
  dirs: {
    ...
    components: ["app/components/layouts"],
    componentsPrefixed: [],
    layouts: ["app/layouts"],
    plugins: ["app/plugins"],
